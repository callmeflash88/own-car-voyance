...
export const Faq = () => {
  return (
    <section className="relative py-32 flex flex-col justify-start items-start overflow-hidden bg-white">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-4">
        <div className="flex w-full max-w-2xl lg:w-1/2 lg:max-w-[380px] flex-col items-start">
