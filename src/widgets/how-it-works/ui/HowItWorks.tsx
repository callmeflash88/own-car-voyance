...
import bgMobile from "../../../../public/assets/images/howItWorks/mobile.png";
    ...
    <section className="relative py-10 lg:py-32 flex flex-col justify-start items-start overflow-hidden bg-white">
      ...
      <div className="w-full max-w-[1200px] mx-auto flex flex-col justify-center items-center z-10 relative px-4">
        ...
        <p className="font-inter font-normal text-[16px] leading-[155%] tracking-normal text-center mt-7">
          We make it easy to explore vehicles, verify
          <br className="block lg:hidden" /> their history, and connect with
          <br className="hidden lg:block" /> trusted sellers
          <br className="block lg:hidden" /> — all without leaving your screen.
        </p>
      </div>
        ...
        <div className="w-full flex flex-wrap flex-col md:flex-row md:gap-0 lg:max-w-[620px] lg:mx-auto lg:box-content lg:px-4 mt-10">
          ...
          <div className="flex flex-row flex-1 md:flex-1/2 lg:flex-col gap-3 items-start">
            ...
            <div>
              ...
              <p className="font-inter font-normal text-[16px] leading-[27px] tracking-normal align-middle">
                Whether you&apos;re buying or listing a<br /> car, our tools
                help you stay safe
                <br /> and informed.
              </p>
            </div>
